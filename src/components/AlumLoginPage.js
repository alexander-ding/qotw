...
const LoginPage = ({firebase, firestore, auth, location, error, updateError}) => {
  ...
  return (
    ...
    <Alert variant="info">To acquire an alumni account, please contact a current quotemaster via <a href="mailto:cws.qotw@gmail.com?Subject=Alumni%20Email%20Request" target="_top">cws.qotw@gmail.com</a></Alert>
